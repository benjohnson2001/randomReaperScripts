...
function addPoints(trackEnvelope)
	...
	local currentBpm = reaper.TimeMap2_GetDividedBpmAtTime(0, 0)
	local lengthOfSixteenthNoteInSeconds = 60000/currentBpm/4/1000

	reaper.InsertEnvelopePoint(trackEnvelope, startTime-lengthOfSixteenthNoteInSeconds, minValue, 4, 0, true, true)
	reaper.InsertEnvelopePoint(trackEnvelope, startTime, centerValue, 0, 0, true, true)

	reaper.InsertEnvelopePoint(trackEnvelope, endTime, centerValue, 3, 0, true, true)
	reaper.InsertEnvelopePoint(trackEnvelope, endTime+lengthOfSixteenthNoteInSeconds, minValue, 0, 0, true, true)
